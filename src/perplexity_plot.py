...
"""
    ...
    def create_region_info(self, regions: List[Dict[str, Any]]) -> str:
        ...
        for i, region in enumerate(regions):
            ...
            region_info_html.append(f'<div class="region-info">{info_text}</div>')
...
"""
        ...
        if show_regions_info and regions:
            region_info_html = self.create_region_info(regions)
...
"""
        ...
        generation_html = self.visualize_single_generation(
            ...
            prompt_token_count, generation_id, show_regions_info
        )
